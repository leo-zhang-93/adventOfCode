# -*- coding: utf-8 -*-
"""
Created on Tue Dec 19 21:50:51 2023
...
seen = defaultdict(lambda: [[float('inf')] * 4 for _ in range(4)])
seen[(0, 0)] = [[0] * 4 for _ in range(4)]
# queue = [0, 0]
# while queue: 
#     x, y = queue.pop(0)
...
#                 seen[(x + dx, y + dy)] = [[float('inf')] * 4 for _ in range(4)]
...
#                     continue
#                 seen[(x + dx, y + dy)][idx][1] = min(seen[(x + dx, y + dy)][idx][1], min(seen[(x, y)][newidx]))
